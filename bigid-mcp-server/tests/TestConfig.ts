...
export const TEST_CONFIG = {
  ...
  timeouts: {
    initialization: 90000, // 90 seconds for server initialization (sandbox)
    apiCall: 60000,        // 60 seconds for individual API calls
    testCase: 120000,      // 120 seconds for entire test case
  },
